...
vim.keymap.set({'n', 'v'}, '<A-S-up>', '<cmd>t-1<cr>', { desc = 'Copy line up'})

vim.keymap.set('i', '<A-S-down>', '<Esc><cmd>t.<cr>a', { desc = 'Copy line down'})
vim.keymap.set({'n', 'v'}, '<A-S-down>', '<cmd>t.<cr>', { desc = 'Copy line down'})
...
vim.keymap.set('n', '<leader>mf', '<cmd>%s/', { desc = 'Replace in current file' })
vim.keymap.set('n', '<leader>mc', '<cmd>s//g<left><left>', { desc = 'Replace in current file' })

vim.keymap.set('n', '<leader>fc', '<cmd>e %:h/',{  desc = 'Create File' })
vim.keymap.set('n', '<leader>fn', '<cmd>e ', { desc = 'Create File' })
